...
public:
    ...
    // function to know address of middle element of list
    // Time complexity:  O(n)
    // Space complexity:  O(1)
    Node *middleElement()
    {
    ...
    // Space complexity:  O(log n) , If you consider recursion stack then you got log n stacks each with O(1) so O(log n) , else O(1)
    Node *listMergeSort()
    {
        ...
        second->head = head2;
        merge(listMergeSort(), second->listMergeSort());
        return head;
    }

    // function to delete one of duplicate elements in list
    // Time complexity:  O(n)
    // Space complexity:  O(1)
    void set()
    {
...

{
    ...
    // deleting duplicate element in list and then display/print the list
    list->set();
    ...
    // Time complexity:  O(n*log(n))
    // Space complexity:  O(n) , considering input space taken by list otherwise O(log n) according to listMergeSort function.
    return 0;
}